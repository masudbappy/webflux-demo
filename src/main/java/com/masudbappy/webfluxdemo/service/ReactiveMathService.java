package com.masudbappy.webfluxdemo.service;
...
public class ReactiveMathService {
    ...
    public Flux<Response> multiplicationTable(int input) {
        return Flux.range(1,10)
                .delayElements(Duration.ofSeconds(1)) // this non-blocking
//                .doOnNext(i -> SleepUtil.sleepSeconds(1)) // this is a blocking code
